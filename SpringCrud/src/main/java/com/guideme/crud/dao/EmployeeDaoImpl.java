...
public class EmployeeDaoImpl implements EmployeeDAO {
	...
	public List<Employee> getlistOfEmployees() {
		...
		String query = "SELECT employeeid, firstname, lastname, email FROM employee";
		List<Employee> list = template.query(query, getSqlParamsByModel(null), new UserMapper());
		return list;
	}

	public void addEmployee(Employee e) {
		String query = "INSERT INTO employee(firstname, lastname, email) VALUES (:firstname, :lastname, :email)";
		template.update(query, getSqlParamsByModel(e));
	}

	public void updateEmployee(Employee e) {
		String query = "UPDATE employee SET firstname = :firstname, lastname = :lastname , email = :email WHERE firstname = :firstname";
		template.update(query, getSqlParamsByModel(e));
	}
